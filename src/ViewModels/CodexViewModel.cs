...
namespace COMPASS.ViewModels
{
    public class CodexViewModel : ViewModelBase
    {
        ...
        //Open File Offline
        private ReturningRelayCommand<Codex> _openCodexLocallyCommand;
        public ReturningRelayCommand<Codex> OpenCodexLocallyCommand => _openCodexLocallyCommand ??= new(OpenCodexLocally, CanOpenCodexLocally);
        ...
        //Open File Online
        private ReturningRelayCommand<Codex> _openCodexOnlineCommand;
        public ReturningRelayCommand<Codex> OpenCodexOnlineCommand => _openCodexOnlineCommand ??= new(OpenCodexOnline, CanOpenCodexOnline);
        ...
        //Open Multiple Files
        private ReturningRelayCommand<IEnumerable<Codex>> _openSelectedCodicesCommand;
        public ReturningRelayCommand<IEnumerable<Codex>> OpenSelectedCodicesCommand => _openSelectedCodicesCommand ??= new(OpenSelectedCodices);
