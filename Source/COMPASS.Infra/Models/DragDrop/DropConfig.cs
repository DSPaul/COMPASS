...
{
    public abstract class DropConfig
    {
        /// <summary>
    ...
    public class DropConfig<T> : DropConfig where T : class
    {
        public DropConfig(DataFormat<T> dataFormat, DragDropEffects dropEffects, Action<T> onDropped)
        {
